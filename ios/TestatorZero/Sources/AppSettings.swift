...
final class AppSettings: ObservableObject {
    ...
    @Published var nodeURL: String {
        didSet { UserDefaults.standard.set(nodeURL, forKey: "node_url") }
    }
    // Pre-formulated "text" nudges, generated by the API when the app is
    // open and scheduled into local notifications for the days ahead.
    @Published var nudges: [String] {
        didSet { UserDefaults.standard.set(nudges, forKey: "nudges") }
    }
    var nudgesAt: Date? {
        get { UserDefaults.standard.object(forKey: "nudges_at") as? Date }
        set { UserDefaults.standard.set(newValue, forKey: "nudges_at") }
    }
    ...
    init() {
        ...
        nudges = UserDefaults.standard.stringArray(forKey: "nudges") ?? []
        nodeURL = UserDefaults.standard.string(forKey: "node_url") ?? "http://testate.local"
    }
